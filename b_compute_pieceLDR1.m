% In this version we add more random variables d_{kl}

function [y,opt_LDR, T]=b_compute_pieceLDR1(dist_flag, cvk,cvd,L_capacity, U_capacity, L_demand, U_demand, trun_r, trun_rd,x,c,s,h,p)
